...
_INTENTS: dict[str, tuple[str, list[str], int]] = {
    "wifi_connect": (
        "连接WiFi",
        [
            "连接wifi", "连wifi", "连网", "上网设置", "配置wifi",
            "wifi设置", "网络设置", "连无线", "设置网络",
        ],
        1,
    ),
    "wifi_scan": (
        "扫描WiFi",
        [
            "扫描wifi", "搜wifi", "搜网络", "扫描网络", "搜无线",
            "wifi列表", "可用网络", "附近wifi", "查看wifi",
        ],
        1,
    ),
    "wifi_status": (
